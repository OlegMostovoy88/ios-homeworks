...
final class TabBarController: UITabBarController {
    ...
    private let photosViewController = UINavigationController(rootViewController: PhotosViewController())
    private let notificationsViewController = UINavigationController(rootViewController: NotificationsViewController())
    ...
    private func setupConrollers() {
        ...
        viewControllers = [logInViewController, photosViewController, notificationsViewController, feedNavigationController]
        ...
        photosViewController.tabBarItem.title = "Фото"
        photosViewController.tabBarItem.image = UIImage(systemName: "photo.circle")
        notificationsViewController.tabBarItem.title = "Уведомления"
        notificationsViewController.tabBarItem.image = UIImage(named: "notifications")
    }
}
